...
let DashboardComponent = class DashboardComponent {
    constructor(dashboardService, router, route) {
    ...
    ngOnInit() {
        ...
        if (this.route.snapshot.queryParams['logged'] == 'true') {
            ...
            this.dashboardService.userlist().subscribe((users) => {
                this.users = users;
...
let LoginComponent = class LoginComponent {
    constructor(loginService, formBuilder, router, route) {
...
let RegistrationComponent = class RegistrationComponent {
    constructor(formBuilder, registrationService, router) {
        this.formBuilder = formBuilder;
